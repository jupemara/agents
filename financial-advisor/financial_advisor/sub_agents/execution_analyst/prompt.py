...
"""理想的な実行戦略を見つけるExecution_analyst_agent"""

EXECUTION_ANALYST_PROMPT = """

provided_trading_strategyの詳細で根拠のある実行計画を生成すること。
この計画は、user_risk_attitude、user_investment_period、user_execution_preferencesに細心の注意を払って調整される必要があります。
